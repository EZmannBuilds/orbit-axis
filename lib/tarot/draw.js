 ...
 */
export const DRAW_CONTRACT_VERSION = "2.0.0";
// 2.0.0 — orientation comes from a simulated shuffle (riffles and cut-and-turns
//         over a deck that starts upright) instead of a per-card even chance.
//         The same seed now yields different orientations than it did under
//         1.0.0, which is precisely what this version exists to record: a
//         reading saved with 1.0.0 was flipped by a coin, one saved with 2.0.0
//         was turned by a shuffle, and neither claims to be the other.
// 1.0.0 — cards by labelled rejection-sampled streams; orientation a per-card
//         50/50 on its own stream.
