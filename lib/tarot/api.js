...
import {
  ...
  resolveDeck, saveReading, validateTimezone,
} from "./service.js";
import { SPREAD_POSITIONS, SPREAD_TYPES, deckStatus } from "./deck.js";
...
export async function handleTarotRoute(method, route, params, body = {}, context = {}) {
  ...
  try {
    if (route === "/api/tarot/daily" && method === "GET") {
      ...
      const reading = dailyCard({ deck, deckVersion, timezone, subject, now });
